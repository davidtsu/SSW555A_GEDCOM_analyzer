...
class Test_US39(unittest.TestCase):
    ...
    def test_US39_upcoming_anniversaries(self):
        ...
        self.assertEqual(g.US39_print_upcoming_anniversaries, [('04/18/1990', 'Husband: Father /Lastname/', 'Wife: Mother /Oldlastname/')])

        # no upcoming anniversary
        g = GED_Repo([os.path.join(os.getcwd(), "test_directory", "US39", "US39_No_Upcoming_Anniversaries.ged")])
        self.assertEqual(g.US39_print_upcoming_anniversaries, "No upcoming anniversaries.")
